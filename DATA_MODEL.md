...
1. **ทะเบียนที่ดินและสิ่งก่อสร้าง (แบบ พ.ด.1):**
   - ใช้กับรายการทรัพย์สินที่อยู่ในกลุ่มประเภทสินทรัพย์ (`general_info.asset_type`) ต่อไปนี้:
     - `ที่ดินที่มีกรรมสิทธิ์`
     - `อาคารสำนักงาน`
     - `สิ่งปลูกสร้าง`
   - พิมพ์ในรูปแบบแนวนอน (A4 Landscape Layout) ด้วยโทนสีเขียวเป็นหลัก
2. **ทะเบียนครุภัณฑ์ ปศุสัตว์ และสัตว์พาหนะ (แบบ พ.ด.2):**
   - ใช้กับรายการทรัพย์สินที่นอกเหนือจากประเภทที่ดินและอาคารทั้งหมด (เช่น ครุภัณฑ์สำนักงาน, คอมพิวเตอร์, ยานพาหนะ)
   - พิมพ์ในรูปแบบแนวนอน (A4 Landscape Layout) ด้วยโทนสีเหลืองเป็นหลัก
...
- ดึงรหัส 3 ตัวแรกจากรหัสพัสดุ (`usage.asset_id`) หากรหัสเริ่มต้นด้วยตัวเลข เช่น `001-67-0005` จะจัดกลุ่มเป็นรหัส `001`
- หากรหัสเป็นฟอร์แมตกำหนดเอง ระบบจะจับคู่จากประเภทสินทรัพย์ตามตารางค่าเริ่มต้นนี้:

| ประเภทสินทรัพย์ (`asset_type`) | รหัสประเภท 3 หลักแรก | ชื่อกลุ่มประเภทที่ใช้ในงบหน้า พ.ด.3 |
| :--- | :--- | :--- |
| **ที่ดินที่มีกรรมสิทธิ์** | `101` | ที่ดินที่มีกรรมสิทธิ์ |
| **อาคารสำนักงาน** | `102` | อาคารสำนักงาน |
| **สิ่งปลูกสร้าง** | `103` | สิ่งปลูกสร้าง |
| **ครุภัณฑ์สำนักงาน** | `311` | ครุภัณฑ์สำนักงาน |
| **ครุภัณฑ์ยานพาหนะและขนส่ง** | `312` | ครุภัณฑ์ยานพาหนะ |
| **ครุภัณฑ์ไฟฟ้าและวิทยุ** | `313` | ครุภัณฑ์ไฟฟ้าและวิทยุ |
| **ครุภัณฑ์โฆษณาและเผยแพร่** | `314` | ครุภัณฑ์โฆษณาและเผยแพร่ |
| **ครุภัณฑ์งานบ้านงานครัว** | `315` | ครุภัณฑ์งานบ้านงานครัว |
| **ครุภัณฑ์วิทยาศาสตร์และการแพทย์**| `316` | ครุภัณฑ์วิทยาศาสตร์ทางการแพทย์ |
| **ครุภัณฑ์กีฬา** | `317` | ครุภัณฑ์กีฬา |
| **ครุภัณฑ์คอมพิวเตอร์** | `412` | ครุภัณฑ์คอมพิวเตอร์ |
| **สินทรัพย์ไม่มีตัวตนอื่น** | `501` | สินทรัพย์ไม่มีตัวตนอื่น |
